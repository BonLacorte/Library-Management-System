...
public class BookDTO {
    ...
    @Digits(integer = 8, fraction = 2, message = "Price must have at most 8 integer digits and 2 decimal value")
    private BigDecimal price;

    @Size(max = 300, message = "Image URL must not exceed 500 characters")
