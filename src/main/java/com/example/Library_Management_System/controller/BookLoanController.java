...
import com.example.Library_Management_System.payload.*;
...
public class BookLoanController {
    ...
    public ResponseEntity<?> updateBookLoan(
            ...
            @Valid @RequestBody com.example.Library_Management_System.payload.request.UpdateBookLoanRequest updateRequest) {
        try {
