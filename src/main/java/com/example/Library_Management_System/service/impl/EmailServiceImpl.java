...
import com.example.Library_Management_System.payload.EmailNotificationDTO;
...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    public void sendOverdueReminder(String recipient, String userName, String bookTitle, String dueDate, int overdueDays, String fineAmount) {
    ...
    @Override
    public void sendDueDateReminder(String recipient, String userName, String bookTitle, String dueDate, int daysUntilDue) {
    ...
    private String buildOverdueReminderHtml(String userName, String bookTitle, String dueDate, int overdueDays, String fineAmount) {
        return """
            <!DOCTYPE html>
            <html>
            <head>
