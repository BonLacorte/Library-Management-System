...
import com.example.Library_Management_System.payload.CheckoutStatistics;
...
import com.example.Library_Management_System.payload.request.BookLoanSearchRequest;
...
import com.example.Library_Management_System.payload.request.RenewalRequest;
...
public class BookLoanServiceImpl implements BookLoanService {
    ...
    @Override
    public BookLoanDTO updateBookLoan(Long bookLoanId, com.example.Library_Management_System.payload.request.UpdateBookLoanRequest updateRequest) throws BookLoanException {
        // 1. Validate book loan exists
        BookLoan bookLoan = bookLoanRepository.findById(bookLoanId)
                .orElseThrow(() -> new BookLoanException("Book loan not found with id: " + bookLoanId));
