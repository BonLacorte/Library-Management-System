...
import com.example.Library_Management_System.controller.PaymentController;
...
import com.example.Library_Management_System.event.PaymentFailedEvent;
import com.example.Library_Management_System.event.PaymentInitiatedEvent;
import com.example.Library_Management_System.event.PaymentSuccessEvent;
import com.example.Library_Management_System.event.publisher.PaymentEventPublisher;
import com.example.Library_Management_System.exception.PaymentException;
import com.example.Library_Management_System.mapper.PaymentMapper;
import com.example.Library_Management_System.modal.*;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentInitiateResponse initiatePayment(
        ...
        // 1. Validate user
        User user = userRepository.findById(request.getUserId()).orElseThrow(() -> new PaymentException("User not found with ID: " + request.getUserId()));
        ...
        // Publish payment initiated event so that other services can react
    ...
    public RevenueStatisticsResponse getMonthlyRevenue() {
        ...
        // Determine currency (default to USD if mixed/null)
