...
import com.example.Library_Management_System.mapper.SubscriptionMapper;
import com.example.Library_Management_System.modal.Payment;
import com.example.Library_Management_System.modal.Subscription;
...
import com.example.Library_Management_System.repository.SubscriptionRepository;
...
public class SubscriptionServiceImpl implements SubscriptionService {
    ...
    private final com.example.Library_Management_System.repository.SubscriptionPlanRepository subscriptionPlanRepository;

    // public SubscriptionDTO subscribe(SubscriptionDTO subscriptionDTO) throws SubscriptionException, UserException {
    //     // 1. Get current user
    ...
    //         .orElseThrow(() -> new SubscriptionException("Subscription plan not found with ID: " + subscriptionDTO.getPlanId()));
    ...
    public PaymentInitiateResponse renewSubscription(Long subscriptionId, SubscribeRequest request) throws SubscriptionException, UserException, PaymentException {
