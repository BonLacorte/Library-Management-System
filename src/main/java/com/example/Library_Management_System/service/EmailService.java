...
public interface EmailService {
     ...
     */
    void sendDueDateReminder(String recipient, String userName, String bookTitle, String dueDate, int daysUntilDue);
     ...
     */
    void sendReservationAvailableNotification(String recipient, String userName, String bookTitle, String availableUntil, int holdPeriodHours);
}
